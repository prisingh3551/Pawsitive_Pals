            ...
            <nav className="navbar">
                <div className="container-fluid">
                    ...
                    <div>
                        ...
                        <Link to="/Login" className='btn btn-lg btn-outline-dark me-3' id='loginBtn'>Login</Link>
                        <Link to="/SignUp" className='btn btn-lg btn-outline-dark me-3' id='signupBtn'>Sign-Up</Link>
                    </div>                 
                </div>
             </nav>
        </div>
